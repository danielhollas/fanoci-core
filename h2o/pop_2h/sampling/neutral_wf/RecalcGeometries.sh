...
jobs=15                  # determines number of jobs to submit
                        # the calculations will be distributed accordingly
nproc=1
submit="qsub -V -cwd -q nq-gpu -l num_gpu=1 -pe shm $nproc " # comment this line if you do not want to submit jobs automatically
